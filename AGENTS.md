...
Code you may edit is not a constraint: before rejecting a design or calling a defect
inherent, name the smallest edit that would remove it and why that edit is out of scope.
