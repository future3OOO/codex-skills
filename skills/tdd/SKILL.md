...
- Run one probe for that atomic behavior through its recorded Seam, reusing an existing test or direct production operation. [Proof versus regression coverage](tests.md) decides what test code, if any, to commit.
