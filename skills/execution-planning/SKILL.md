...
If sub-agents are appropriate for the task, spawn one critique agent (spawn_agent, agent_type=default) after the first full draft and before finalizing the design. The critique pass should check at minimum:
