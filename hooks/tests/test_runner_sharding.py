...
class ProbeTreeTests(RunnerAttack):
    ...
    def test_two_jobs_of_one_run_get_two_homes(self) -> None:
        ...
        rather than requiring its caller to leave CODEX_HOME alone."""
        ...
        tree = self.probe_tree(
            ...
            "    def test_one(self): print('[JOB_HOME=' + os.environ['CODEX_HOME'] + ']')\n"
            "    def test_two(self): print('[JOB_HOME=' + os.environ['CODEX_HOME'] + ']')\n",
        )
